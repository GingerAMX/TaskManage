            ...
            <main>
               <div class="margin_box">
                    <div class="box">
                        ...
                        <input type="submit" class="square_btn" value="教員" name="teacher" style="width: 140px;height: 60px;">
                        </form>
                        </div>
                        <form action="/TaskManage/UserIndex" method="POST" name="checkform">
                        <div class="namelist_margin">
                        <div class="namelist1">
                        <label><input type="checkbox" name="checkbox" class="all_check" id="AllCheck">全選択</label>
                        <div class="namelist_box">
                            ...
                            <div class="namelist2">
                                <input type="submit" class="square_btn" value="選択削除" style="width: 145px;height: 60px;"><br>
