		...
		<div class="content_task">
						...
						<tbody class="task_tbody">
							<%
								...
								while (j < resultList.size()) {
									...
									out.println("<tr>");
									out.println("<td class=\"TaskID\">" + result.getTaskID() + "</td>" + "<td class=\"TaskName\">"
											+ result.getTaskName() + "</td>" + "<td class=\"DeadLine\">" + date[j] + "</td> "
											+ "<td class=\"Grade_Class\">" + result.getGrade() + "年" + result.getcName() + "組" + "</td>"
											+ "<th class=\"BUTTON\">＞</th>");
									out.println("<tr>");
									j = j + 1;
								}
			...
			<div class="content_task3">
				<div class="task_distribution">
					<a href="#" class="square_btn">配布</a>
				</div>
				<div class="task_acquisition">
					<a href="#" class="square_btn"> ファイルの取得</a>
				</div>
